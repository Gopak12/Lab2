...
def generate(mn, mx, cnt):
    return [round(random.uniform(mn, mx)) for i in range(cnt)]
...
lb = Label(window, text='Input from file ')
...
lb_border_left.grid(row=3, column=0)

border_left_entry = Entry(window)
border_left_entry.grid(row=4, column=0)

lb_border_right = Label(window, text='Right Border: ')
lb_border_right.grid(row=3, column=1)

border_right_entry = Entry(window)
border_right_entry.grid(row=4, column=1)

lb_count = Label(window, text='Count of Elements: ')
lb_count.grid(row=3, column=2)

count_entry = Entry(window)
count_entry.grid(row=4, column=2)
...
dia_chastot_but.grid(row=6, column=0)
...
pol_chastot_but.grid(row=6, column=1)
...
his_chastot_but.grid(row=6, column=2)
...
discrete_info_but.grid(row=7, column=0)
...
interval_info_but.grid(row = 7, column =0 )
...
emp_but.grid(row=7, column=1)

discr_label = Label(window, text = 'Discrete and Unintervated distributions')
